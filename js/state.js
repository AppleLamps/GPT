 ...
 * @param {{role: string, content: string, imageData?: string | null}} message - The message object.
 * imageData is optional and contains the base64 string of the image if present.
 */
export function addMessageToHistory(message) {
    // Ensure imageData is either a string or explicitly null/undefined
    const messageToAdd = { ...message, imageData: message.imageData || null };
